...
export const api = {
  ...
  createRoom: (payload) => request("/api/admin/rooms", { method: "POST", body: JSON.stringify(payload) }),
  updateRoomConfig: (roomId, payload) =>
    request(`/api/admin/rooms/${roomId}/config`, { method: "PATCH", body: JSON.stringify(payload) }),
